...
class BroAIApp : Application() {
    ...
    companion object {
        ...
        const val S_AUTO_NAV="autoNav"; const val S_DETECTION="detection"; const val S_FACE_REC="faceRec"
        const val S_GUARDIAN="guardian"; const val S_EMERGENCY="emergency"; const val S_OBSTACLE="obstacle"
    }
}